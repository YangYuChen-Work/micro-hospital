  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      ...
      <div class="nav-item">
        <span class="v-link clickable dark"
          :onclick="'javascript:window.location=\'/hospital/suspend/'+hospital.hoscode+'\''"> 停诊信息 </span>
      </div>
      <div class="nav-item">
        <span class="v-link clickable dark"
          :onclick="'javascript:window.location=\'/hospital/query/'+hospital.hoscode+'\''"> 查询/取消 </span>
      </div>
    </div>
    <!-- 左侧导航 #end -->
    <!-- 右侧内容 #start -->
    <div class="page-container">
      <div class="hospital-detail">
        ...
        <div class="info-wrapper"><img :src="hospital.logoData" :alt="hospital.hosname" style="width: 80px; height: 80px;">
