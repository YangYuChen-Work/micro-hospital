    ...
    children: [
      {
        ...
        component: () => import('@/views/yygh/help/category/list'),
        meta: { title: '分类管理', icon: 'table' }
      },
      {
        path: 'article/list',
        name: 'HelpArticleList',
        component: () => import('@/views/yygh/help/article/list'),
        meta: { title: '文章管理', icon: 'table' }
      },
      {
        path: 'article/form',
        name: 'HelpArticleForm',
        component: () => import('@/views/yygh/help/article/form'),
        meta: { title: '添加/编辑文章', noCache: true },
        hidden: true
      },
      {
        path: 'feedback/list',
        name: 'HelpFeedbackList',
        component: () => import('@/views/yygh/help/feedback/list'),
